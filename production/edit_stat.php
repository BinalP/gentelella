    ...
    <div class="col-md-3 left_col menu_fixed">
      ...
      <!-- /menu footer buttons -->
        ...
        <div class="right_col" role="main">
         ...
         <h3>Edit <?php echo $row['s_name']?></h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="edit_the_stat.php?sid=<?php echo $sid; ?>">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="sname" value="<?php echo $row['s_name'];?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="xlabel" value="<?php echo $row['x_label'];?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Y-label</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="ylabel" value="<?php echo $row['y_label'];?>">
                        </div>
                      </div>
                        ...
                        <?php if($row['x_type']=='int' || $row['y_type']=='int'){ ?>
                        "<option>line</option>
                        <option>pie</option>
                        <option>bar</option>
                         <?php } else{?>
                       ...
                       <div class="form-group" >
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Description</label>
                         ...
                         <textarea name="description" class="col-xs-12 col-md-6"><?php echo $row['s_desc']?></textarea>
