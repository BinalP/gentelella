...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js"></script>
  ...
  <div class="container body">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="add_new_stat.php?pid=1">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="sname">
                        </div>
                      </div>
                   
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">X-label</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="xlabel">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Y-label</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="ylabel">
                        </div>
                      </div>
                     
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">X-type</label>
                        <div class="col-md-2 col-sm-9 col-xs-12">
                          <select class="form-control" name="xtype" id="xtype">
                            <option>text</option>
                       ...
                       <div class="form-group" >
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Y-type</label>
                        <div class="col-md-2 col-sm-9 col-xs-12">
                          <select class="form-control" name="ytype" id="ytype">
                            <option>text</option>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Statistic's type</label>
                        <div class="col-md-2 col-sm-9 col-xs-12">
    ...
    $("#xtype").change(function () {
         valx = $(this).val();
        if (valx == "int" || valy=='int') {
            $("#stype").html("<option>line</option><option>pie</option><option>bar</option>");
        } else {
            $("#stype").html("<option>line</option>");
        }
    });
})
 $(document).ready(function () {
    $("#ytype").change(function () {
         valy = $(this).val();
      if (valx == "int" || valy=='int') {
            $("#stype").html("<option>line</option><option>pie</option><option>bar</option>");
        } else {
            $("#stype").html("<option>line</option>");
                       ...
                       <div class="form-group" >
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Description</label>
                         ...
                         <textarea name="description" class="col-xs-12 col-md-6"></textarea>
