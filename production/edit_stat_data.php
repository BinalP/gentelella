            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                 ...
                 <form action="add_stat_data.php?sid=<?php echo $sid;?>" >
        <input type="text" id="X-value" placeholder="X-value" name="xvalue">
        <input type="text" id="Y-value" placeholder="Y-value" name="yvalue">
  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <table id="datatable" class="table table-striped table-bordered" >
        ...
        <thead>
            ...
            <?php $query=mysql_query("SELECT * FROM statdata WHERE s_id='".$sid."'") or die(mysql_error());
           while( $rdata=mysql_fetch_array($query)){ ?>
           <form method="post" action="delete_stat_data.php?sid=<?php echo $sid;?>">
            <tr><td><input type='text'  value="<?php echo $rdata['x']?>" name='x'></td>
            <td><input type='text' + value="<?php echo $rdata['y']?>" name='y'></td></tr>
